...
QString StrConstants::getOpenBSDNews(){
  return QObject::tr("OpenBSD news");
}
...
QString StrConstants::getComment(){
...
QString StrConstants::getLineEditTextRemote(){
  return QObject::tr("Type the package name and press ENTER");
}
...
QString StrConstants::getYoullNeedSuFrontend(){
  return QObject::tr("You'll need to install baiacu-doas.");
}
...
QString StrConstants::getErrorRunningWithRoot(){
  return QObject::tr("You can not run Baiacu with administrator's credentials.");
}
